...
--
-- Name: index_source_maps_on_filename; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_source_maps_on_filename ON source_maps USING btree (filename);
